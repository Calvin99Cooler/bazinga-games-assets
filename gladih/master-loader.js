...
var scripts = document.getElementsByTagName("script"),
    ...
    loaders = {
        unity: "https://cdn.jsdelivr.net/gh/Calvin99Cooler/bazinga-games-assets@main/gladih/unity.js"
    };
if (0 <= window.location.href.indexOf("pokiForceLocalLoader") 
	&& (loaders.unity = "https://cdn.jsdelivr.net/gh/Calvin99Cooler/bazinga-games-assets@main/gladih/unity.js", 
...
if (!window.config.unityWebglLoaderUrl) {
    var versionSplit = window.config.unityVersion ? window.config.unityVersion.split(".") : [],
        ...
        minor = versionSplit[1];
          window.config.unityWebglLoaderUrl ="https://cdn.jsdelivr.net/gh/Calvin99Cooler/bazinga-games-assets@main/gladih/UnityLoader.2019.2.js";
    // switch (year) {
    //     case "2019":
...
sdkScript.src = "https://cdn.jsdelivr.net/gh/Calvin99Cooler/bazinga-games-assets@8901b847539a63757203319877a2aa222b7a8b4d/gladih/poki-sdk.js", sdkScript.onload = function() {
